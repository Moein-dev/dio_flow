...
class PaginationHelper {
  ...
  static Future<List<T>> fetchAllPages<T>({
    required Future<SuccessResponseModel> Function(Map<String, dynamic>)
    apiCall,
...
class PaginationMeta {
  ...
  static PaginationMeta fromResponse(
...
class PaginatedResult<T> {
  ...
  PaginatedResult({required this.items, required this.meta});
